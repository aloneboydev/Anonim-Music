...
<b>✨ **Developer** : [ɢʟɪᴛᴛᴇʀ ᴇx](https://t.me/Biarenakliatnyaaaa)
""",
...
¹ <b>{title1[:50]}</b>
  ╠ ※ [ʀᴇᴘᴏ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ](https://t.me/{BOT_USERNAME}?start=info_{ID1})
  ╠ ※ **ᴅᴇᴠᴇʟᴏᴘᴇʀ** : [ɢʟɪᴛᴛᴇʀ](https://t.me/Biarenakliatnyaaaa)
  ╚ ※ **ᴘᴇᴍɪʟɪᴋ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ**

² <b>{title2[:50]}</b>
  ╠ ※ [ʀᴇᴘᴏ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ](https://t.me/{BOT_USERNAME}?start=info_{ID2})
  ╠ ※ **ᴅᴇᴠᴇʟᴏᴘᴇʀ** : [ɢʟɪᴛᴛᴇʀ](https://t.me/Biarenakliatnyaaaa)
  ╚ ※ **ᴘᴇᴍɪʟɪᴋ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ**

³ <b>{title3[:50]}</b>
  ╠ ※ [ʀᴇᴘᴏ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ](https://t.me/{BOT_USERNAME}?start=info_{ID3})
  ╠ ※ **ᴅᴇᴠᴇʟᴏᴘᴇʀ** : [ɢʟɪᴛᴛᴇʀ](https://t.me/Biarenakliatnyaaaa)
  ╚ ※ **ᴘᴇᴍɪʟɪᴋ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ**

⁴ <b>{title4[:50]}</b>
  ╠ ※ [ʀᴇᴘᴏ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ](https://t.me/{BOT_USERNAME}?start=info_{ID4})
  ╠ ※ **ᴅᴇᴠᴇʟᴏᴘᴇʀ** : [ɢʟɪᴛᴛᴇʀ](https://t.me/Biarenakliatnyaaaa)
  ╚ ※ **ᴘᴇᴍɪʟɪᴋ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ**

⁵ <b>{title5[:50]}</b>
  ╠ ※ [ʀᴇᴘᴏ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ](https://t.me/{BOT_USERNAME}?start=info_{ID5})
  ╠ ※ **ᴅᴇᴠᴇʟᴏᴘᴇʀ** : [ɢʟɪᴛᴛᴇʀ](https://t.me/Biarenakliatnyaaaa)
  ╚ ※ **ᴘᴇᴍɪʟɪᴋ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ**
""",
            reply_markup=InlineKeyboardMarkup(buttons),
...
async def startyuplay(_, CallbackQuery):
    ...
    m = await CallbackQuery.message.reply_photo(
        ...
        caption=f"""
<b>🏷️ **Nama** :</b> [{title[:50]}]({url})
╚ 💡 [Repo Anonim Music](https://t.me/{BOT_USERNAME}?start=info_{id})
...
⁶ <b>{title6[:50]}</b>
  ╠ ※ [ʀᴇᴘᴏ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ](https://t.me/{BOT_USERNAME}?start=info_{ID6})
  ╠ ※ **ᴅᴇᴠᴇʟᴏᴘᴇʀ** : [ɢʟɪᴛᴛᴇʀ](https://t.me/Biarenakliatnyaaaa)
  ╚ ※ **ᴘᴇᴍɪʟɪᴋ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ**

⁷ <b>{title7[:50]}</b>
  ╠ ※ [ʀᴇᴘᴏ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ](https://t.me/{BOT_USERNAME}?start=info_{ID7})
  ╠ ※ **ᴅᴇᴠᴇʟᴏᴘᴇʀ** : [ɢʟɪᴛᴛᴇʀ](https://t.me/Biarenakliatnyaaaa)
  ╚ ※ **ᴘᴇᴍɪʟɪᴋ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ**

⁸ <b>{title8[:50]}</b>
  ╠ ※ [ʀᴇᴘᴏ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ](https://t.me/{BOT_USERNAME}?start=info_{ID8})
  ╠ ※ **ᴅᴇᴠᴇʟᴏᴘᴇʀ** : [ɢʟɪᴛᴛᴇʀ](https://t.me/Biarenakliatnyaaaa)
  ╚ ※ **ᴘᴇᴍɪʟɪᴋ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ**

⁹ <b>{title9[:50]}</b>
  ╠ ※ [ʀᴇᴘᴏ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ](https://t.me/{BOT_USERNAME}?start=info_{ID9})
  ╠ ※ **ᴅᴇᴠᴇʟᴏᴘᴇʀ** : [ɢʟɪᴛᴛᴇʀ](https://t.me/Biarenakliatnyaaaa)
  ╚ ※ **ᴘᴇᴍɪʟɪᴋ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ**

¹⁰ <b>{title10[:50]}</b>
  ╠ ※ [ʀᴇᴘᴏ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ](https://t.me/{BOT_USERNAME}?start=info_{ID10})
  ╠ ※ **ᴅᴇᴠᴇʟᴏᴘᴇʀ** : [ɢʟɪᴛᴛᴇʀ](https://t.me/Biarenakliatnyaaaa)
  ╚ ※ **ᴘᴇᴍɪʟɪᴋ ᴀɴᴏɴɪᴍ ᴍᴜsɪᴄ**
""",
            reply_markup=InlineKeyboardMarkup(buttons),
